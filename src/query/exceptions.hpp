...
class SnapshotModificationInMulticommandTxException : public QueryException {
 public:
  SnapshotModificationInMulticommandTxException()
      : QueryException("Snapshot query not allowed in multicommand transactions.") {}
};
