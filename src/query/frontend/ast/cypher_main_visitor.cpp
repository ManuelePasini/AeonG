...
antlrcpp::Any CypherMainVisitor::visitSnapshotQuery(MemgraphCypher::SnapshotQueryContext * /*ctx*/) {
  auto *snapshot_query = storage_->Create<SnapshotQuery>();
  query_ = snapshot_query;
...
antlrcpp::Any CypherMainVisitor::visitPrivilege(MemgraphCypher::PrivilegeContext *ctx) {
  ...
  if (ctx->SNAPSHOT()) return AuthQuery::Privilege::SNAPSHOT;
...
//wzy edit
antlrcpp::Any CypherMainVisitor::visitTt(MemgraphCypher::TtContext *ctx) {
  auto *tt = storage_->Create<Tt>();
  if(ctx->AS()){
    tt->tt_left_ =ctx->as_literal->accept(this);// ctx->_localctx->as_literal->accept(this);
    tt->tt_right_ =ctx->as_literal->accept(this);// ctx->_localctx->as_literal->accept(this);
    return tt;
  }
  tt->tt_left_ = ctx->from_literal->accept(this);
  tt->tt_right_ = ctx->to_literal->accept(this);
  return tt;
}
//wzy edit end
