 ...
 public:
  ...
  class iterator final : public std::iterator<std::input_iterator_tag,                      // iterator_category
   ...
   public:
    ...
    //hjm begin
    explicit iterator(const std::string &prefix,const KVStore *kvstore,bool at_end=false);
    
    explicit iterator(const KVStore *kvstore, bool at_end = false,const std::string &prefix = "");
  ...
  //hjm begin
  iterator starts(const std::string &prefix = "") const { return iterator(prefix,this); }

  iterator last(const std::string &prefix = "") const { return iterator(prefix,this,true); }
  
  iterator begins(const std::string &prefix = "") const { return iterator(this, true,prefix); }

  iterator ends(const std::string &prefix = "") const { return iterator(this, false,prefix); }
