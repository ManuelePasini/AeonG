...
std::pair<std::map<std::string, communication::bolt::Value>,
          std::vector<std::vector<communication::bolt::Value>>>
ExecuteValidationNTimesTillSuccess(communication::bolt::Client *client, const std::string &query,
...
nlohmann::json BoltRecordsToJSONStrings(std::vector<std::vector<communication::bolt::Value>> &results) {
